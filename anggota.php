    ...
    <table>
        ...
        while ($row = $data->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>{$row['alamat']}</td>
                    <td>{$row['no_hp']}</td>
                    <td class='aksi'><a href='anggota.php?hapus={$row['id_anggota']}' onclick=\"return confirm('Yakin ingin menghapus anggota ini?');\">Hapus</a></td>
                  </tr>";
        }
        ?>
    </table>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['tambah'])) {
    ...
    $alamat = $_POST['alamat'];
    $no_hp = $_POST['no_hp'];
    $koneksi->query("INSERT INTO anggota (nama, alamat, no_hp) VALUES ('$nama', '$alamat', '$no_hp')");
